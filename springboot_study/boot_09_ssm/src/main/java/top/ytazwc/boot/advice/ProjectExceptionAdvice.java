package top.ytazwc.boot.advice;

import org.springframework.web.bind.annotation.ExceptionHandler;
import org.springframework.web.bind.annotation.RestControllerAdvice;
import top.ytazwc.boot.domain.result.codes.CommonCode;
import top.ytazwc.boot.domain.result.Result;
import top.ytazwc.boot.exception.BusinessException;
import top.ytazwc.boot.exception.SystemException;
